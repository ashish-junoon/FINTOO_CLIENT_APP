...
function PaymentRedirect() {
    ...
    useEffect(() => {
        ...
        window.history.replaceState(null, null, import.meta.env.VITE_RAZORPAY_BACKURL);
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="grid grid-cols-2 gap-3 my-5">
                        <div className="col-span-2">
                            <div className="text-xs text-center">Transaction Id</div>
                            <div className="text-xs font-semibold text-black">{payInfo.transaction_id}</div>
                        </div>

                        <div className="col-span-1">
                            <div className="flex flex-col justify-center items-center">
                                <div className=" text-xs">Method</div>
                                <div className="text-xs text-black font-semibold uppercase">{payInfo.method}</div>
                            </div>
                        </div>
                        <div className="col-span-1">
                            <div className="flex flex-col justify-center items-center">
                                <div className=" text-xs">Amount</div>
                                <div className="text-xs text-black font-semibold">{payInfo.amount}</div>
                            </div>
                        </div>
                    </div>
                    <button
